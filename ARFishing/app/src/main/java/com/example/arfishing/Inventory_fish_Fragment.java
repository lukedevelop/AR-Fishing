...
public class Inventory_fish_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_inventory_fish,container,false);
        return rootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btn_inventory_fish_fishFragment = (Button) view.findViewById(R.id.btn_inventory_fish_fishFragment);
        Button btn_inventory_bait_fishFragment = (Button) view.findViewById(R.id.btn_inventory_bait_fishFragment);
        Button btn_inventory_interior_fishFragment = (Button) view.findViewById(R.id.btn_inventory_interior_fishFragment);

        btn_inventory_fish_fishFragment.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_inventory_bait_fishFragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mainActivity.getSupportFragmentManager()
                        .beginTransaction()
        ...
        btn_inventory_interior_fishFragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mainActivity.getSupportFragmentManager()
                        .beginTransaction()
    ...
    void update_Inventory(View view) {
        ListView listView = view.findViewById(R.id.list_inventory_fish);
